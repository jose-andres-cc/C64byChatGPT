...
private void ldy(int value) {
    ...
    public void execute(int op){
        ...
        switch(op){
            ...
            case 0x3D -> and(fetch(absX()));
            case 0x39 -> and(fetch(absY()));
            ...
            case 0x5D -> eor(fetch(absX())); 
            case 0x59 -> eor(fetch(absY())); 
            ...
            case 0x7D -> adc(fetch(absX())); 
            case 0x79 -> adc(fetch(absY())); 
            ...
            case 0xFD -> sbc(fetch(absX())); 
            case 0xF9 -> sbc(fetch(absY())); 
